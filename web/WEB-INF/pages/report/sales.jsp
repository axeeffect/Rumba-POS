...
<body>
	...
	<div class="bodywrapper">
		...
		<div class="pageheader">
			...
			<ul class="hornav">
				<li class="current">
					<a onclick="return false">Laporan Penjualan</a>
				</li>
				<li>
					<a href="<c:url value="/report/stock"/>">Laporan Stok Barang</a>
				</li>
			</ul>
		</div>
		...
		<div class="contentwrapper">
			<div id="validation" class="subcontent">
				<form id="form3" onkeypress="return event.keyCode != 13;" class="stdform" method="get" action="sales/print">
				<p>
				<label>Periode Awal</label>
					<span class="field">
						<input id="startdate" class="smallinput" type="date" name="startdate" value="${startdate}" />
					</span>
				</p>
				<p>
				<label>Periode Akhir</label>
					<span class="field">
						<input id="enddate" class="smallinput" type="date" name="enddate" value="${enddate}" />
					</span>
				</p>

				<!-- BUTTON ACTION -->
				<p class="stdformbutton">
					<button class="submit radius2">Cari</button>
				...
				<tr>
				<td colspan="3">
					<display:table id="report" name="order" requestURI="" export="true" pagesize="25">
						<display:column property="tanggal" title="Tanggal Order" />
						<display:column title="Nama Item" />
				   		<display:column title="Jumlah Order" />
					    <display:column title="Total Harga" />
					</display:table>
				</td>
				</tr>
				</table>
